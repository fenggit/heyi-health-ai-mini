...
const MOCK_UPLOAD_DATA = {
  title: "趣味视觉测评",
  intro:
    "上传舌苔与面部照片，AI 将结合传统养生知识为你生成专属的趣味体质小测评，仅供生活参考与娱乐互动。",
  introNotice: "本内容由AI生成，属于趣味娱乐性质，不构成任何医疗建议，如有健康问题请咨询专业医生。",
  tongueTip: "张嘴伸舌，舌头平展，自然光线下拍摄，确保图像清晰。",
  sublingualTip: "抬起舌头，自然光线下拍摄，确保图像清晰可见。",
