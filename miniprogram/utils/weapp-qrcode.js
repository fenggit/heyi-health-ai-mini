...
// Adapted for WeChat miniapp by tomfriwel/weapp-qrcode (MIT License)
...
(function () {
    ...
    QRCode.prototype.makeImage = function (callback) {
        ...
        _oContext.setFillStyle(_htOption.colorLight);
        ...
        for (var row = 0; row < nCount; row++) {
            for (var col = 0; col < nCount; col++) {
                ...
                _oContext.fillRect(Math.floor(nLeft), Math.floor(nTop), nRoundedWidth, nRoundedHeight);
            }
        }
